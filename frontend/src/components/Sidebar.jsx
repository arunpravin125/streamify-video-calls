...
const Sidebar = () => {
  ...
  return (
    <aside className="w-64 bg-base-200 border-r border-base-300 hidden  lg:flex flex-col  sticky top-0  min-h-screen">
      ...
      <div className="p-4 border-t border-base-300 mt-auto">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-success flex item-center gap-1">
